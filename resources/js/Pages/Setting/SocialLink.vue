                    ...
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="mt-2 flex flex-col justify-center">
                            ...
                            <form class="bg-white inline-block shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full">
                                <div class="mb-2"><span class="text-sm">Social Name</span>
                                    <select
        ...
        <div class="py-12">
            <div class="mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div>
                        <h3 class="p-3 text-center"> Social Link List</h3>
                        <table
                        ...
                        >
                            <thead>
                            <tr>
                                <th class="border">Social Site Name</th>
                                <th class="border">Url link</th>
                                <th class="border">Action</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr v-for="setting in settings" :key="setting.id">
                                <td class="border">{{ setting.name }}</td>
                                <td class="border">{{ setting.data }}</td>
                                <td class="border">
                                    <button @click="editCoupon(setting)"
                                            class="
                                                            bg-white
                                                            hover:bg-gray-100
                                                            text-gray-800
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            addCoupon() {
                this.form.post(route("admin.store.social_link"), {
                    preserveScroll: true,
                    forceFormData: true,
                    onSuccess() {
                        Swal.fire({
            ...
            editCoupon(data) {
                ...
                this.form.setting_id = data.id;
                this.form.type = data.name;
                this.form.social_link = data.data;
                this.editMode = true;
                this.openModal();
            },
            updateCoupon() {
            ...
            deleteCoupon(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        this.form.delete(route("admin.delete_social_link", id), {
                            preserveScroll: true,
                            forceFormData: true,
                            onSuccess() {
                                Swal.fire({
