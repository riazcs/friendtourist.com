                        ...
                        <div class="mt-2 flex flex-col justify-center">
                            ...
                            <form class="bg-white inline-block shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full">
                                ...
                                <div class="mb-2"> <span class="text-sm">Answer</span>
                                    <textarea  rows="8" class="w-full border rounded focus:outline-none focus:border-gray-300" v-model="form.answer">
</textarea>
                                </div>
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            updateFaq() {
                this.form.post(route("admin.faq.update", this.faq_id), {
                    preserveScroll: true,
                    forceFormData: true,
                    onSuccess() {
                        Swal.fire({
            ...
            deleteFaq(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        this.form.delete(route("admin.faq.destroy", id), {
                            preserveScroll: true,
                            forceFormData: true,
                            onSuccess() {
                                Swal.fire({
