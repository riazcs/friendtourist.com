                ...
                "
                        ...
                        <div class="mt-2 flex flex-col justify-center">
                            ...
                            <form class="bg-white inline-block shadow-md rounded px-8 pt-6 pb-8 mb-4 w-full">
                                <div class="mb-2"> <span class="text-sm">Name</span> <input type="text" class="h-12 px-3 w-full border-gray-200 border rounded focus:outline-none focus:border-gray-300"  v-model="form.name"> </div>
        ...
        <div class="py-12">
            <div class="mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div>
                        <h3 class="p-3 text-center">Blog Type List</h3>
                        <table
                        ...
                        >
                            <thead>
                            <tr>
                                <th class="border">Type Name</th>
                                <th class="border">Action</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr v-for="blog_type in blog_types" :key="blog_type.id">
                                <td class="border">{{ blog_type.data }}</td>
                                ...
                                <td class="border">
                                    ...
                                    <!--                                    </button>-->
                                    <button
                                        @click="deleteAmenity(blog_type.id)"
                                        class="
                        bg-blue-500
                        hover:bg-blue-700
                        text-white
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            addArea() {
                this.form.post(route("admin.blog.add_blog_type"), {
                    preserveScroll: true,
                    forceFormData: true,
                    onSuccess() {
                        Swal.fire({
