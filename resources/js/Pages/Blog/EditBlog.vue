            ...
            <div class="mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    <div class="mt-2 flex flex-col justify-center">
                        ...
                        <form class="bg-white inline-block rounded px-8 pt-6 pb-8 mb-4" @submit.prevent="update()">
                            ...
                            <div v-if="blog.attachment.id" class="mx-1 mb-2 rounded-lg shadow-lg ">
                                <div class="h-40 w-48 relative">
                                    <img class="h-full w-full rounded-lg"
                                         :src="blog.attachment.file_path"
                                         alt="blog header image" />
                                    <svg @click.prevent="delete_image(blog.attachment.id)" xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-red-500 absolute right-0 top-0 pr-1 block" viewBox="0 0 20 20" fill="currentColor">
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            update() {
                this.form.post(route("admin.blog.update", this.blog_id), {
                    preserveScroll: true,
                    forceFormData: true,
                    onSuccess() {
                        Swal.fire({
